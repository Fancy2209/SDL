...
JOB_SPECS = {
    ...
    "vita-vgl": JobSpec(name="Sony PlayStation Vita (GLES w/ vitaGL)",      os=JobOs.UbuntuLatest,      platform=SdlPlatform.Vita,        artifact="SDL-vita-vitagl",        container="vitasdk/vitasdk:latest", vita_gles=VitaGLES.Vgl, ),
    ...
    match spec.platform:
        ...
        case SdlPlatform.Vita:
            ...
            job.cmake_arguments.extend((
                ...
                f"-DVIDEO_VITA_VGL={ 'true' if spec.vita_gles == VitaGLES.Vgl else 'false' }",
                "-DSDL_ARMNEON=ON",
                "-DSDL_ARMSIMD=ON",
                ))
